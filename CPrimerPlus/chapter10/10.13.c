#include <stdio.h>
void save_dat(int size, int n, double *ar[]);
double ccl_each_set(int n, double ar[]);
double ccl_all_set(int size, int n, double *ar[]);
double maxnum(int size, int n, double *ar[]);
void print(int size, int n, double *ar[]);
int main(void)
{
    int size = 5, n = 3;
    double arr[3][5];
