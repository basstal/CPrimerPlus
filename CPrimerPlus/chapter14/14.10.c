...
void getchoice(Seat planeseat[][MAXSEAT],int plane)
{
	...
	while(choice!=5){
		switch(choice)	
		{
		case 0:pf[choice](planeseat[plane]);
			break;
		case 1:pf[choice](planeseat[plane]);
			break;
		case 2:pf[choice](planeseat[plane]);
			break;
		case 3:pf[choice](planeseat[plane]);
			break;
		case 4:pf[choice](planeseat[plane]);
		}
		choice=showmenu();
	}
}
